...
router.delete('/:id', async (req, res) => {
  ...
  try {
    ...
    const toDelete = productTagIds.map(({ tag_id }) => tag_id);

    const productData = await ProductTag.destroy({ where: { id: toDelete } });
    productData.tags = await Category.destroy({ where: { id: req.params.id } });
